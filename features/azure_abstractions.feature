Feature: Azure File Share Abstractions

    Background:
        Given I create a "AzureFileShare" integration
        And I connect to the demo azure file share account
